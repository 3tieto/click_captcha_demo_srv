...
ALTER TABLE IF EXISTS ONLY public.tld DROP CONSTRAINT IF EXISTS tld_val_key;
ALTER TABLE IF EXISTS ONLY public.tld DROP CONSTRAINT IF EXISTS tld_pkey;
ALTER TABLE IF EXISTS ONLY public.mail DROP CONSTRAINT IF EXISTS mail_pkey;
ALTER TABLE IF EXISTS ONLY public.mail DROP CONSTRAINT IF EXISTS mail_host_id_val_key;
ALTER TABLE IF EXISTS ONLY public.host DROP CONSTRAINT IF EXISTS host_tld_id_val_key;
ALTER TABLE IF EXISTS ONLY public.host DROP CONSTRAINT IF EXISTS host_pkey;
ALTER TABLE IF EXISTS public.tld ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.mail ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.host ALTER COLUMN id DROP DEFAULT;
DROP SEQUENCE IF EXISTS public.tld_id_seq;
DROP TABLE IF EXISTS public.tld;
DROP SEQUENCE IF EXISTS public.mail_id_seq;
DROP TABLE IF EXISTS public.mail;
DROP SEQUENCE IF EXISTS public.host_id_seq;
DROP TABLE IF EXISTS public.host;
DROP FUNCTION IF EXISTS public.tld_upsert(s text);
DROP FUNCTION IF EXISTS public.mail_upsert(prefix text, host_val text, tld_val text);
DROP FUNCTION IF EXISTS public.host_upsert(host_val text, tld_val text);
